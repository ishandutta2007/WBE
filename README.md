...
- The storage and compute eatimate as you can see are insignification compared to SEM despite the fact we are quite conservative. Kurzweil says we will have $1k 30PFlops. We are 3000x conservative(abd realistic) to that as we expect $1M for 100PFlops as we see no change of Kurzweil's prediction coming true.
