...
- The above tables ignore mainitenance costs. There will be small maintenece cost of electricticy and internet. Average human consumes ~10KWh per month but a 100PLOP brain on silicon will consume roughly ~10,000 KWH per month by 2040s and nomal household will have 1TBPS internet connection by 2040s, which should be enough for cloud collaborations. So you can assume $1K per month maintenance cost.
